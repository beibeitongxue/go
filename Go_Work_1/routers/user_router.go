...
func (router RouterGroup) UserRouter() {
	...
	router.PUT("user_password", middleware.JwtAuth(), app.UserUpdatePassword)   //更新密码
	router.PUT("user_email", middleware.JwtAuth(), app.UserUpdateEmail)         //更新邮箱
	...
	router.POST("user_deviceID", middleware.JwtAuth(), app.GetDeviceID)         //获取设备ID
}
